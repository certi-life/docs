export const docsSections = [
  ...
  {
    label: 'Hospital 화면별 안내',
    description: 'Hospital 병원 관리자 화면의 메뉴별로 인증서 발행과 설정, 발행 내역과 환자 관리, 예약과 후기, 주문과 계약, 병원 정보와 계정, 알림톡을 다루는 방법을 목적별로 안내합니다.',
    docs: [
      'hospital/screens/overview',
      'hospital/screens/dashboard',
      'hospital/screens/brand-page',
      'hospital/screens/issue-certificate',
      'hospital/screens/certificate-settings',
      'hospital/screens/history',
      'hospital/screens/reservations-reviews',
      'hospital/screens/orders',
      'hospital/screens/contracts',
      'hospital/screens/hospital-info',
      'hospital/screens/accounts',
      'hospital/screens/alimtalk',
    ],
  },
  {
    label: 'Manufacturer',
  ...
  {
    label: 'Studio 화면별 안내 - CRM',
    description: 'CRM 메뉴에서 고객을 등록하고 나누고, 템플릿을 만들어 캠페인과 시나리오 자동화로 메시지를 보내는 방법을 목적별로 안내합니다.',
    docs: [
      ...
      'studio/screens/crm/message-status',
    ],
  },
  {
  ...
  {
    label: 'Studio 화면별 안내 - 콜봇',
    description: '콜봇 메뉴에서 전화를 받는 AI 상담원을 만들고 도구·지식·번호를 연결해 실제 통화에 쓰기까지의 방법을 목적별로 안내합니다.',
    docs: [
      ...
      'studio/screens/callbot/dtmf-menus',
      'studio/screens/callbot/knowledge',
      'studio/screens/callbot/campaign',
      'studio/screens/callbot/phone-numbers',
      'studio/screens/callbot/users',
      'studio/screens/callbot/verification',
    ],
  },
  {
    label: 'Studio 화면별 안내 - 상담',
    description: '상담 메뉴에서 응대할 상담을 찾고, 시작·이관·마무리하고, 번역과 답변 도구, 고객 정보를 활용하는 방법을 목적별로 안내합니다.',
    docs: [
  ...
  {
    label: 'Studio 화면별 안내 - 설정',
    description: '조직 공통 설정에서 상담 시간, 알림, 번역, 채널 연동, 자동메시지, 상담 기록 양식을 정하는 방법을 목적별로 안내합니다.',
    docs: [
